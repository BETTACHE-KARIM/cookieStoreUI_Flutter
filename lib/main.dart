import 'package:cookie_store_ui/AppBar.dart';
import 'package:cookie_store_ui/BottomBar.dart';
import 'package:cookie_store_ui/CookiePage.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Cookie Store Page'),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {},
        backgroundColor: Color.fromARGB(255, 53, 50, 239),
